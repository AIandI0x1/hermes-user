  ...
  function PluginCard(props) {
    ...
    return h("div", {
      ...
      h("div", { className: "hhh-chip-row" },
        ...
        plugin.hasTheme ? h("span", { className: "hhh-chip hhh-chip-theme" }, "theme") : null,
        plugin.hasDashboard ? h("span", { className: "hhh-chip hhh-chip-primary" }, "dashboard") : h("span", { className: "hhh-chip" }, plugin.kind || "runtime"),
        ...
        .then(function (results) {
          ...
          const list = Array.isArray(data) ? data.map(function (plugin) {
            ...
            return {
              ...
              hasTheme: Boolean(plugin.has_theme),
              themeNames: plugin.theme_names || [],
              route: plugin.route || "",
          ...
          h(CardContent, null,
            selected ? h("div", { className: "hhh-stack" },
              ...
              h("div", { className: "hhh-detail-grid" },
                ...
                h("div", null, h("span", { className: "hhh-detail-label" }, "Themes"), h("strong", null, selected.themeNames && selected.themeNames.length ? selected.themeNames.join(", ") : "-")),
