(function () {
  ...
  const PUBLISHER_NAME = "plugin-publisher";
  ...
  function loadDefaults(pluginName) {
    ...
    return SDK.fetchJSON("/api/plugins/plugin-publisher/defaults", {
      method: "POST",
  ...
  function loadReadme(pluginName) {
    ...
    return SDK.fetchJSON("/api/plugins/plugin-publisher/readme", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ plugin_name: pluginName }),
    }).then(function (data) {
  ...
  function publishPlugin(plugin, overlay) {
    ...
    SDK.fetchJSON("/api/plugins/plugin-publisher/publish", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
  ...
  function PublisherPage() {
    ...
    function fetchPlan() {
      ...
      SDK.fetchJSON("/api/plugins/plugin-publisher/plan", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
