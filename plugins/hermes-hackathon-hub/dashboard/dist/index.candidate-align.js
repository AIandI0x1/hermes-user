(function () {
  ...
  function buildSubmission(form, selected) {
    ...
    return [
      ...
      repoUrl,
      currentPlugins ? "" : null,
      currentPlugins ? "Current plugins:" : null,
      currentPlugins || null,
      "",
      "Screenshots / video:",
      mediaUrls,
      ...
      "",
      "Notes:",
      form.notes || "Generated by Hermes Hackathon Hub. Official Hermes certification is unavailable until a signed registry/public key exists.",
